...
import { ArtigosQuadros } from "./Components/ArtigosQuadros";
import { ArtigosEsculturas } from "./Components/ArtigosEsculturas";
import { ArtigosArtesanatos } from "./Components/ArtigosArtesanatos";
    ...
    <Router>
      <div>
        <Switch>
          ...
          <Route path="/artigosQuadros">
            <ArtigosQuadros />
          </Route>
          <Route path="/artigosEsculturas">
            <ArtigosEsculturas />
          </Route>
          <Route path="/artigosArtesanatos">
            <ArtigosArtesanatos />
          </Route>
        </Switch>
      </div>
