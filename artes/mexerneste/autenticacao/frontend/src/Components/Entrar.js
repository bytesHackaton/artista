  ...
  return (
    <div className="h-[100vh] overflow-hidden w-full bg-corPrincipal flex flex-col gap-3 ">
      <div className="flex items-end ml-[2rem] h-[18rem] w-full">
        <h1 className="text-[#fff] font-sfdisplay-bold text-[3rem] ">Entrar</h1>
      </div>
        ...
        <div className="flex flex-col gap-2 px-8">
          ...
          <div class="flex items-start w-full">
            <input
              type="checkbox"
              id="hs-small-switch"
              class="relative shrink-0 w-11 h-6 bg-gray-100 checked:bg-none checked:bg-green-500 rounded-full cursor-pointer transition-colors ease-in-out duration-200 border border-transparent ring-1 ring-transparent focus:border-green-600 focus:ring-green-600 ring-offset-white focus:outline-none appearance-none dark:bg-white-700 dark:checked:bg-green-600 dark:focus:ring-offset-gray-800

  before:inline-block before:w-5 before:h-5 before:bg-red-500 checked:before:bg-white before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-gray-400 dark:checked:before:bg-blue-200"
            />
            <label
              for="hs-small-switch"
              class="font-sfdisplay-medium text-sm text-[#fff] ml-3 dark:text-[#fff] tracking-wide"
            >
              Guardar sessão
            </label>
          </div>
