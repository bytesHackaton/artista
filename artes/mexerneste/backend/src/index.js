...
app.get("/api/artigos/quadros", async (req, res) => {
  try {
    const categoria = "quadros";
...
app.get("/api/artigos/esculturas", async (req, res) => {
  try {
    const categoria = "esculturas";
    const eventos = await getEventsByCategory(categoria);
...
app.get("/api/artigos/artesanatos", async (req, res) => {
  try {
    const categoria = "artesanatos";
    const eventos = await getEventsByCategory(categoria);
...
app.post("/api/artigos/quadros", authorize, async (req, res) => {
  try {
    const { title, description, image, category, price, state } = req.body;
    const categoria = "quadros";
...
app.post("/api/artigos/esculturas", authorize, async (req, res) => {
  try {
    const { title, description, image, category, price, state } = req.body;
    const categoria = "esculturas";
    const evento = await createEventByCategory(req.body, categoria);
...
app.post("/api/artigos/artesanatos", authorize, async (req, res) => {
  try {
    const { title, description, image, category, price, state } = req.body;
    const categoria = "artesanatos";
    const evento = await createEventByCategory(req.body, categoria);
